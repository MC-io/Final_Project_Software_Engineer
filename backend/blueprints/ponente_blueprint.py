...
@ponente_blueprint.route('/ponente/create', methods=['POST']) # Verificar si se encuentra en la base de datos
@cross_origin()
...
@ponente_blueprint.route('/ponente/get', methods=['POST']) # Verificar si se encuentra en la base de datos
@cross_origin()
def get_asistente():
